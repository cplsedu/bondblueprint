...
/* FOOTNOTES */
.fn-note { display: flex; gap: 12px; align-items: flex-start; padding: 9px 0; border-bottom: 1px solid var(--border); }
...
.fn-where { font-size: 11.5px; font-weight: 800; color: var(--text); margin-bottom: 3px; }
.fn-body { font-size: 11.5px; font-weight: 600; color: var(--muted); line-height: 1.6; }
.fn-cite { font-size: 10px; font-weight: 700; color: var(--teal); margin-top: 4px; font-style: italic; }
