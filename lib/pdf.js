...
<div class="section-page">
  ...
  <div style="text-align:center;margin:24px 0 20px;">
    <div style="font-size:13.5px;font-weight:700;color:var(--text);line-height:1.7;margin-bottom:18px;max-width:600px;margin-left:auto;margin-right:auto;text-align:left;">If you're noticing a repeating pattern of conflicts, and that you can't seem to be with your partner without arguing, that is a sign of a communication breakdown. Please book a 1:1 call with me to start rebuilding as soon as possible, before it's too late.</div>
