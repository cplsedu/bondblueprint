...
<div style="max-width:560px;margin:0 auto;padding:28px 16px 40px">
  ...
  <div style="background:#FFFFFF;border-radius:14px;padding:30px 28px;border:1.5px solid #DDD7CE;margin-bottom:16px">
    ...
    <p style="margin:0 0 14px;font-size:15px;color:#5A5450;line-height:1.75;">
      Your Blueprint is attached as a PDF. Your cycle map, the insecurity underneath your triggers, what you actually need, the scripts, the 7-day plan — all of it was built from what you shared. It's yours.
    </p>
    ...
    <div style="background:#FDF0E6;border-left:3px solid #E07A3A;border-radius:0 10px 10px 0;padding:16px 20px;margin:20px 0">
      ...
      <p style="margin:0 0 7px;font-size:14px;color:#1E1E1E;line-height:1.65;font-weight:600">Then read your cycle map and what you actually need underneath the trigger.</p>
      <p style="margin:0 0 7px;font-size:14px;color:#1E1E1E;line-height:1.65;font-weight:600">When you both feel calm, have the cycle conversation. The page walks you through it.</p>
