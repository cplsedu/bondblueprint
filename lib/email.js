...
async function sendClaimReminderEmail({ to, piId, type, origin }) {
  ...
  const body = isFirst
    ? `You already got your BondBlueprint. It just needs a few honest answers from you before we can build it and send it your way.<br><br>It takes about 2 minutes. Click below and we'll get it done.`
    : `It's been a week, and your BondBlueprint is still sitting there ready to be built. It's yours. We just need a few answers from you so we can personalize it and send it straight to your inbox.<br><br>Whenever you're ready, it's waiting.`;
