...
async function sendClaimReminderEmail({ to, piId, type, origin }) {
  ...
  const subject = isFirst
    ...
    : "Your blueprint is still here (don't lose it)";

  const headline = isFirst
    ? "You're almost there."
    : "One week later, still yours.";

  const body = isFirst
    ? `You grabbed your BondBlueprint a little while ago but didn't finish personalizing it yet. No worries — we saved your spot.<br><br>We just need a few honest answers from you so we can build it specifically for your situation. It takes about 2 minutes.`
    : `It's been a week and your BondBlueprint is still waiting for you. We haven't given your spot to anyone else.<br><br>Answer a few questions and we'll build your personal blueprint and send it straight to your inbox. Takes 2 minutes.`;
...
module.exports = { sendBlueprintEmail, sendOwnerNotificationEmail, sendClaimReminderEmail };
